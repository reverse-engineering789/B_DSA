...
// Given an integer K and a queue of integers, we need to
...
// In-built functions of the respective languages can be used 
...
// Your Task:
// Complete the provided function modifyQueue that takes 
// queue and k as parameters and returns a modified queue. 
