...
public:
    int compress(vector<char>& chars) {
        ...
        while(i < n){
            ...
            // if u traverse the vector completely 
            // or, encounterd new/different characters 
            ...
            if(count > 1){
                // coverting counting into single digit and saving in answer
